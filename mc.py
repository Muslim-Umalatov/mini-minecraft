...
jump_gravity = 0.005  # Zıplama yerçekimi
ground_level = 1.5
jump_strength = 0.15
...
def init():
    global forest_positions, texture_id
...
def update_camera():
    global camera_pos, camera_front, speed, is_jumping, jump_velocity, gravity, jump_gravity, ground_level
    ...
    if is_jumping:
        ...
        jump_velocity -= jump_gravity  # Zıplама yerçekimi kullan
        ...
        if camera_pos[1] > ground_level:
            camera_pos[1] -= gravity  # Normal yerçekimi kullan
        else:
            camera_pos[1] = ground_level
...
def update_frame(_):
    ...
    glutTimerFunc(1000 // 100, update_frame, 0)  # 60 FPS (her saniyede 60 kare)
